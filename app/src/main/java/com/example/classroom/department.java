    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        backbtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(department.this,mainpage2.class);
...
//        ArrayList<String> selectedIssues = new ArrayList<>();
        ...
        if (checkBox8.isChecked()) {
            selectedIssues.add("The tables are broken or in poor condition.");
            mailTemplate.append("The tables are broken or in poor condition.\n");
        }
        ...
        Intent intent = new Intent(department.this, depsendreq.class);
