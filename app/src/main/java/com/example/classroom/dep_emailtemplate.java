...
public class dep_emailtemplate extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_dep_emailtemplate);
...
//                    storeDetails(name, email1, classroom, section, selectedIssues);
                    ...
                    Toast.makeText(dep_emailtemplate.this,"No app is installed",Toast.LENGTH_SHORT).show();
                }
            }
        });
...
//
//                Toast.makeText(dep_emailtemplate.this, "Details sent successfully!",
